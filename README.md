...
| **plan** | `/multi-plan` | 多視角規劃設計 | 🔜 Coming |
| **implement** | `/multi-implement` | 監督式並行實作 | 🔜 Coming |
| **review** | `/multi-review` | 多視角程式碼審查 | 🔜 Coming |
| **verify** | `/multi-verify` | 多視角驗證測試 | 🔜 Coming |
| **orchestrate** | `/multi-orchestrate` | 端到端編排 | 🔜 Coming |
...
- 準備 plan, implement, review, verify, orchestrate skill
