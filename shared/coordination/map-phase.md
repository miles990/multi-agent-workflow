...
每個視角 Agent 的 prompt **結尾必須**包含以下指令：

---

### 輸出要求（強制）

⚠️ **你必須執行以下步驟，否則任務視為失敗**：
...
報告長度**無上限**，REDUCE 階段會根據總量自動選擇處理策略。
...
詳見：[reduce-phase.md](./reduce-phase.md) 策略 B 說明
